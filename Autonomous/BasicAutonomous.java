...
@Autonomous(name="BasicAutonomous", group="2021UltimateGoal")
public class BasicAutonomous extends LinearOpMode {
    ...
    // goBilda Yellow Jacket 5202/3
    static final double cpr = 751.8;

    // goBilder Yello Jacket 5204
    // static final int cpr = 3895.9;
    ...
    private void moveForwardOrBack(int distanceInInches, double speed) {
        ...
        // Apply movement
        frontLeftPosition += movement;  // frontLeftPosition = frontLeftPosition + movement;
